...
![Supplies image 13](images/step01_13.jpg)

Below are the components need to build this project along with the parts needed to build the case
...
- 555 X 1 - [Ali express](https://www.aliexpress.com/wholesale?catId=0&initiative_id=SB_20220322163754&isPremium=y&SearchText=555+ic)
- 4017 X 1 - [Ali express](https://www.aliexpress.com/wholesale?catId=0&initiative_id=SB_20220322163810&isPremium=y&SearchText=4017+ic)
- LM3914 X 1 - [Ali express](https://www.aliexpress.com/wholesale?catId=0&initiative_id=SB_20220322163823&isPremium=y&SearchText=lm3914)
- LM386 X 1 - [Ali express](https://www.aliexpress.com/wholesale?catId=0&initiative_id=SB_20220322163836&isPremium=y&SearchText=lm386)
...
![Step 1: A Couple of Options in the Design image 1](images/step02_01.jpg)

![Step 1: A Couple of Options in the Design image 2](images/step02_02.jpg)

After putting together the initial PCB, I decided that I wanted a way to fine tune the horizontal. This creates the waveform structure and having a fine tune allows you to create great looking waveforms.

Version 1 (first schematic) has a couple of extra JST connectors, one for a 50K pot and one for a switch to turn off the fine tune. The reason why I wanted the ability to turn off the fine horizontal is you can get very slow frame rates when it isn't connected and I like the look of them! When the fine horizontal is on, you can't slow frame rates to happen. if you didn't want to bother with the switch, you could just connect the 2 solder points on the PCB. I also wanted to add the fine horizontal pot to the side of the case where it is easy to really fine tune it. If you don't care about the fine tune then you don't have to connect the pot or switch and it will all still work.

Version 2 (second schematic) has the fine horizontal directly connected to the PCB. However, it doesn't have the ability to turn off the fine horizontal.
...
![Step 2: Printing the PCB image 2](images/step03_02.jpg)
...
Remember - there are 2 versions so have a think how you want your board to look.


## Step 3: Adding the LED's to the PCB

![Step 3: Adding the LED's to the PCB image 1](images/step04_01.jpg)

![Step 3: Adding the LED's to the PCB image 2](images/step04_02.jpg)

![Step 3: Adding the LED's to the PCB image 3](images/step04_03.jpg)

![Step 3: Adding the LED's to the PCB image 4](images/step04_04.jpg)

![Step 3: Adding the LED's to the PCB image 5](images/step04_05.jpg)

![Step 3: Adding the LED's to the PCB image 6](images/step04_06.jpg)

![Step 3: Adding the LED's to the PCB image 7](images/step04_07.jpg)

![Step 3: Adding the LED's to the PCB image 8](images/step04_08.jpg)

![Step 3: Adding the LED's to the PCB image 9](images/step04_09.jpg)

![Step 3: Adding the LED's to the PCB image 10](images/step04_10.jpg)

Adding the LED's isn't too hard (just a little time consuming), especially if you use the square ones that I used in the build.
...
![Step 4: Adding the Components to the PCB image 1](images/step05_01.jpg)

![Step 4: Adding the Components to the PCB image 2](images/step05_02.jpg)

![Step 4: Adding the Components to the PCB image 3](images/step05_03.jpg)

![Step 4: Adding the Components to the PCB image 4](images/step05_04.jpg)

![Step 4: Adding the Components to the PCB image 5](images/step05_05.jpg)

![Step 4: Adding the Components to the PCB image 6](images/step05_06.jpg)

![Step 4: Adding the Components to the PCB image 7](images/step05_07.jpg)

![Step 4: Adding the Components to the PCB image 8](images/step05_08.jpg)

![Step 4: Adding the Components to the PCB image 9](images/step05_09.jpg)

![Step 4: Adding the Components to the PCB image 10](images/step05_10.jpg)

![Step 4: Adding the Components to the PCB image 11](images/step05_11.jpg)
...
![Step 5: Testing the PCB (and a Small Mod I Did!) image 1](images/step06_01.jpg)

![Step 5: Testing the PCB (and a Small Mod I Did!) image 2](images/step06_02.jpg)

![Step 5: Testing the PCB (and a Small Mod I Did!) image 3](images/step06_03.jpg)

![Step 5: Testing the PCB (and a Small Mod I Did!) image 4](images/step06_04.jpg)

![Step 5: Testing the PCB (and a Small Mod I Did!) image 5](images/step06_05.jpg)

![Step 5: Testing the PCB (and a Small Mod I Did!) image 6](images/step06_06.jpg)

![Step 5: Testing the PCB (and a Small Mod I Did!) image 7](images/step06_07.jpg)

Testing the board is relatively easy, all you need to do is to add a mic and a power source and you can test it. I also decided to do a mod which was adding the 'fine horizontal' pot and switch to turn it off. You don't have to worry about doing this as I updated the PCB (version 1). Version 2 has the pot connected directly to the board so less wiring. However, you can't turn off the 'fine horizontal'
...
![Step 6: The Front Panel image 1](images/step07_01.jpg)

![Step 6: The Front Panel image 2](images/step07_02.jpg)

![Step 6: The Front Panel image 3](images/step07_03.jpg)

![Step 6: The Front Panel image 4](images/step07_04.jpg)
...
![Step 7: Drilling & Making Cut-outs on the Front Panel image 1](images/step08_01.jpg)

![Step 7: Drilling & Making Cut-outs on the Front Panel image 2](images/step08_02.jpg)

![Step 7: Drilling & Making Cut-outs on the Front Panel image 3](images/step08_03.jpg)

![Step 7: Drilling & Making Cut-outs on the Front Panel image 4](images/step08_04.jpg)

![Step 7: Drilling & Making Cut-outs on the Front Panel image 5](images/step08_05.jpg)

![Step 7: Drilling & Making Cut-outs on the Front Panel image 6](images/step08_06.jpg)

![Step 7: Drilling & Making Cut-outs on the Front Panel image 7](images/step08_07.jpg)

![Step 7: Drilling & Making Cut-outs on the Front Panel image 8](images/step08_08.jpg)
...
I decided to make the case so the front panel was on a 45 degree angle. It helps give a better viewing angle
...
![Step 9: Adding the Switch, Pot, Mic & BNC Connector to the Case image 1](images/step10_01.jpg)

![Step 9: Adding the Switch, Pot, Mic & BNC Connector to the Case image 2](images/step10_02.jpg)

![Step 9: Adding the Switch, Pot, Mic & BNC Connector to the Case image 3](images/step10_03.jpg)

![Step 9: Adding the Switch, Pot, Mic & BNC Connector to the Case image 4](images/step10_04.jpg)

![Step 9: Adding the Switch, Pot, Mic & BNC Connector to the Case image 5](images/step10_05.jpg)

![Step 9: Adding the Switch, Pot, Mic & BNC Connector to the Case image 6](images/step10_06.jpg)

![Step 9: Adding the Switch, Pot, Mic & BNC Connector to the Case image 7](images/step10_07.jpg)

As mentioned earlier, I made a modification to the PCB and added a fine horizontal pot to make it easier to fine tune the waveforms. There are 2 versions of the PCB's (I used V1), the 2nd version has the 'fine horizonal' attached to the PCB.
...
![Step 10: Adding a Power Source image 1](images/step11_01.jpg)

![Step 10: Adding a Power Source image 2](images/step11_02.jpg)

![Step 10: Adding a Power Source image 3](images/step11_03.jpg)

![Step 10: Adding a Power Source image 4](images/step11_04.jpg)

![Step 10: Adding a Power Source image 5](images/step11_05.jpg)

![Step 10: Adding a Power Source image 6](images/step11_06.jpg)

![Step 10: Adding a Power Source image 7](images/step11_07.jpg)

![Step 10: Adding a Power Source image 8](images/step11_08.jpg)

You could power everything by a 9V battery. I like to use rechargeable batteries for my builds and have decided to use an old mobile battery to power everything. If you have seen any of my projects over the last couple of years, then you would have seen me do this many times.
...
![Step 11: Connecting Everything Together image 1](images/step12_01.jpg)

![Step 11: Connecting Everything Together image 2](images/step12_02.jpg)

![Step 11: Connecting Everything Together image 3](images/step12_03.jpg)

![Step 11: Connecting Everything Together image 4](images/step12_04.jpg)

![Step 11: Connecting Everything Together image 5](images/step12_05.jpg)

![Step 11: Connecting Everything Together image 6](images/step12_06.jpg)

Now that you have everything added to the case, it's time to connect everything together. I use mini JST connector to easily connect the wires to the PCB. See link in supplies
...
![Step 12: How to Use the LED Oscillator image 1](images/step13_01.jpg)

![Step 12: How to Use the LED Oscillator image 2](images/step13_02.jpg)

![Step 12: How to Use the LED Oscillator image 3](images/step13_03.jpg)

![Step 12: How to Use the LED Oscillator image 4](images/step13_04.jpg)

![Step 12: How to Use the LED Oscillator image 5](images/step13_05.jpg)

![Step 12: How to Use the LED Oscillator image 6](images/step13_06.jpg)

![Step 12: How to Use the LED Oscillator image 7](images/step13_07.jpg)
