...
3. Next I added the reverb and echo module next to the speaker. You may notice some wires coming off the module, these are w[here](https://www.instructables.com/Echo-Reverb-Box/) the echo and reverb pots are connected to. You need to do a couple of mods to the module and I've done an Instructable on how to do this which you can find here
