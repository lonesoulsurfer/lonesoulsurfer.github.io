...
This circuit creates an arpeggiator effect using some [vactol](https://www.instructables.com/id/How-to-Make-a-Optocoupler-Vactrol/)s (this this 'ible on how to make ta vactol, also known as a opticoupler). It gives the synth another sound effect which is fun to play around with. However, it isn't necessary to add this circuit if you don't want to.
